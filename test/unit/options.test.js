...
!developmentChains.includes(network.name)
    ? describe.skip
    : describe.only("Options unit tests", async () => {
          ...
          describe("Get DAI/ETH price data from oracle", async () => {
          ...
          describe("Option parameters", async () => {
              const amount = 1
              const premiumDue = 1
              const daysToExpiry = 1

              describe("Writing a call", async () => {
                  const strike = 1000
              ...
              describe("Buy call options", async () => {
                  const strike = 1000
                  const daiAmount = 1000
              ...
              describe("Write a put option contract", async () => {
                  const strike = 1000
                  const daiAmount = 1000
              ...
              describe("Exercise call options", async () => {
                  const strike = 1000
                  const daiAmount = 1000
              ...
              describe("Exercise put options", async () => {
              ...
              describe("Option expires worthless", async () => {
              ...
              describe("Writer gets funds back", async () => {
